...
void *commands_send(void *arg)
{
    ...
    while(cancel == 0)
    {
        ...
        else if(strstr(command, "Login") != NULL && logat == 1)
        {
            strcat(command, login);
            strcat(command, "\n");
            command[strlen(command)] = '\0';
        ...
        else if(strstr(command, "Sign in") != NULL && logat == 1)
        {
            strcat(command, sign_in);
            strcat(command, "\n");
            command[strlen(command)] = '\0';
        ...
        else if(strstr(command, "Destinatie") != NULL && logat == 1)
        {
            char dest[MSGSIZE];
        ...
        else if(strstr(command, "Log out") != NULL)
        {
            fflush(stdout);
        ...
        else if(strstr(command,"Meniu") != NULL && logat == 1)
        {
            main_meniu();
        }
